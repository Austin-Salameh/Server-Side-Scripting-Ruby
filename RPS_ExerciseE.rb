...
# Date:        July 25th, 2020
# 
# Description: This Ruby games a computerized version of the classic 
#              children’s Rock, Paper, Scissors game, in which the player goes 
#              head-to-head against the computer.
# Game Add-ons: Single letter shorthand, Count number of games played, Count number of wins, losses, ties, Descriptive feedback after the game result, Include an alert 
#
#--------------------------------------------------------------------------
...
class Screen
  ...
  #gamecount variable tracks the number of games played by the user
  $gameCount = 0
